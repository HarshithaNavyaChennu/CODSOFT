...
listbox = tk.Listbox(window, width=50, height=10, font=("verdana", 12))
...
entry = tk.Entry(window, font=("verdana", 12))
entry.pack(pady=20)

# Create buttons to add, delete, update, and mark as done tasks
add_button = tk.Button(window, text="Add Task", command=add_task,bg="pink")
add_button.pack(pady=10)
delete_button = tk.Button(window, text="Delete Task", command=delete_task,bg="pink")
delete_button.pack(pady=10)
update_button = tk.Button(window, text="Update Task", command=update_task,bg="pink")
update_button.pack(pady=10)
mark_done_button = tk.Button(window, text="Mark as Done", command=mark_as_done,bg="pink")
